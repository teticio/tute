...
#include "open_spiel/games/tute.h"
...
void BasicGameTests() {
  testing::LoadGameTest("tute");
  testing::ChanceOutcomesTest(*LoadGame("tute"));
  testing::RandomSimTest(*LoadGame("tute"), 10);
  testing::ResampleInfostateTest(*LoadGame("tute"), /*num_sims=*/10);
}
...
int main(int argc, char** argv) {
  open_spiel::tute::BasicGameTests();
  open_spiel::tute::ShootTheMoonTest();
  open_spiel::tute::InformationStateTensorTest();
}
